...
8. `readJsonObject()` - 23 edges
9. `getAuthenticatedAdmin()` - 23 edges
10. `breadcrumbJsonLd()` - 22 edges
...
Cohesion: 0.12
Nodes (22): OPTIONS, POST, EMAIL_TEMPLATES, EmailContact, EmailTemplate, generateFormuleConfirmeeTemplate(), generateRelance1Template(), generateRelance2Template() (+14 more)
...
Cohesion: 0.20
Nodes (12): AdminContactEmail(), composeWithAi(), sendEmail(), authedFetch(), EmailContact, fieldClass(), TEMPLATE_OPTIONS, ADMIN_NOTIFY_EMAIL (+4 more)
