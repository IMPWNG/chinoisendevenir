...
type ContactInfo = {
  ...
  source?: string | null;
  score_qualite?: string | number | null;
};

type ContactForm = ReturnType<typeof contactToForm>;

function translatedOrRaw(t: TranslateFn, prefix: string, value: string) {
  if (!value) return "";
...
function contactToForm(contact: ContactInfo) {
