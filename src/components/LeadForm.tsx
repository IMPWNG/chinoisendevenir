...
type LeadFormErrors = Partial<Record<keyof LeadFormValues, string | null>>;
type LeadFormStatus = "idle" | "submitting" | "success" | "error" | "duplicate";
...
const LeadForm = ({
  ...
  const handleChange = (
    ...
    const field = name as keyof LeadFormValues;
