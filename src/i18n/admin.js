export const adminTranslations = {
  fr: {
    ...
    calendar: {
      ...
      hint: "Appels et visios avec les étudiants, heure de Paris. Cliquez une case pour placer un créneau. L'IA s'en sert pour proposer des dispos.",
      prev: "Prec.",
      next: "Suiv.",
      today: "Aujourd'hui",
      add: "Nouveau RDV",
      ...
      fromAi: "placé par l'IA d'après la réponse",
      kindAppel: "Appel",
      kindVisio: "Visio",
      kindAutre: "Autre",
      missingTable:
    ...
    dashboard: {
      ...
      emailAiHint:
        "Écrivez ce que vous voulez dire, même en vrac. L'IA reformule dans le style des emails déjà envoyés, et consulte le calendrier pour proposer uniquement des créneaux libres. Vous relisez avant d'envoyer.",
      emailAiPlaceholder:
      ...
      emailPreview: "Aperçu",
      emailOfferedSlots: "Créneaux proposés dans le mail (encore libres)",
      emailDraftTitle: "Brouillon de réponse à relire",
      emailDraftHint:
        "L'IA a analysé la réponse de l'étudiant. Vérifiez le mail, modifiez-le si besoin, puis envoyez. Rien ne part sans vous.",
      emailDraftUse: "Préparer cet envoi",
      emailDraftDiscard: "Ignorer",
      emailDraftBooked: "Créneau déjà placé dans le calendrier.",
      emailDraftMoved:
        "L'ancien créneau a été déplacé vers la nouvelle dispo de l'étudiant.",
      emailDraftNeedSlot: "Aucun créneau posé : le mail propose d'autres dispos.",
      emailAnalyzeReply: "Analyser la dernière réponse",
      emailAnalyzeWorking: "Analyse...",
      emailAnalyzeFail: "Analyse impossible : {error}",
      emailAnalyzeNone: "Ce n'est pas une réponse de RDV, ou aucune réponse récente.",
      emailAnalyzeOk: "Réponse analysée. Relisez le brouillon avant envoi.",
  ...
  en: {
    ...
    calendar: {
      ...
      hint: "Calls and video meetings with students, Paris time. Click a cell to book a slot. The AI uses this to offer free times.",
      prev: "Prev.",
      next: "Next",
      today: "Today",
      add: "New meeting",
      ...
      unknown: "Student",
      paris: "Paris time",
      fromAi: "placed by AI from their reply",
      kindAppel: "Call",
      kindVisio: "Video",
      kindAutre: "Other",
      missingTable:
    ...
    dashboard: {
      ...
      emailAiHint:
        "Write what you want to say, even roughly. The AI rewrites it in the same style as our templates and checks the calendar so it only offers free slots. You review before sending.",
      emailAiPlaceholder:
      ...
      emailOfferedSlots: "Slots offered in the email (still free)",
      emailDraftTitle: "Reply draft to review",
      emailDraftHint:
        "AI analysed the student's reply. Check the email, edit if needed, then send. Nothing goes out without you.",
      emailDraftUse: "Prepare this send",
      emailDraftDiscard: "Discard",
      emailDraftBooked: "The slot is already on the calendar.",
      emailDraftMoved:
        "The previous slot was moved to the time the student chose.",
      emailDraftNeedSlot: "No slot booked: the email offers other times.",
      emailAnalyzeReply: "Analyse latest reply",
      emailAnalyzeWorking: "Analysing...",
      emailAnalyzeFail: "Could not analyse: {error}",
      emailAnalyzeNone: "Not an appointment reply, or no recent reply.",
      emailAnalyzeOk: "Reply analysed. Review the draft before sending.",
  ...
  zh: {
    ...
    calendar: {
      title: "预约日历",
      hint: "与学生的电话/视频（巴黎时间）。点击格子即可添加。AI 会据此只提供空闲时段。",
      prev: "上一周",
      next: "下一周",
      today: "今天",
      add: "新预约",
    ...
    dashboard: {
      ...
      emailAiHint:
        "写下你想说的内容，哪怕很随意。AI 会按现有邮件风格改写，并查看日历，只提出空闲时段。发送前请再核对。",
      ...
      emailPreview: "预览",
      emailOfferedSlots: "邮件中提出的时段（仍空闲）",
      emailDraftTitle: "待核对的回复草稿",
      emailDraftHint:
        "AI 已分析学生回复。请核对邮件，必要时修改后再发送。未经你确认不会寄出。",
      emailDraftUse: "准备发送",
      emailDraftDiscard: "忽略",
      emailDraftBooked: "该时段已写入日历。",
      emailDraftMoved: "已把原预约改到学生提出的新时间。",
      emailDraftNeedSlot: "尚未排入日历：邮件会提供其他时间。",
      emailAnalyzeReply: "分析最近一封回复",
      emailAnalyzeWorking: "分析中...",
      emailAnalyzeFail: "无法分析：{error}",
      emailAnalyzeNone: "不是预约回复，或没有近期回复。",
      emailAnalyzeOk: "已分析回复。发送前请核对草稿。",
