export const adminTranslations = {
  fr: {
    ...
    dashboard: {
      ...
      filterOwnerMine: "Dernier touché : moi",
      filterOwnerClosedMine: "Signés par moi (prime)",
      myTouchesStat: "Mes dossiers",
      myClosedStat: "Mes signatures",
  ...
  en: {
    ...
    dashboard: {
      ...
      filterOwnerMine: "Last touched by me",
      filterOwnerClosedMine: "Closed by me (commission)",
      myTouchesStat: "My dossiers",
      myClosedStat: "My closed deals",
  ...
  zh: {
    ...
    dashboard: {
      ...
      allBudgets: "全部预算",
      allOwners: "全部负责人",
      filterOwnerMine: "我最后处理的",
      filterOwnerClosedMine: "我成交的（提成）",
      myTouchesStat: "我的客户",
      myClosedStat: "我的成交",
