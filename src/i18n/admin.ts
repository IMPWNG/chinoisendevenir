export const adminTranslations = {
  fr: {
    ...
    calendar: {
      ...
      hint: "Cliquez une case pour ajouter un rendez-vous. Tout s'affiche en heure de Pékin.",
      prev: "Prec.",
      next: "Suiv.",
      today: "Aujourd'hui",
      add: "Nouveau RDV",
    ...
    dashboard: {
      ...
      paidClients: "Payées",
      filesInPrep: "Dossier en préparation",
      ...
      filterOwnerMine: "Mes dossiers",
      filterOwnerLimited: "Dossiers admin restreint",
      myTouchesStat: "Mes dossiers",
      revenueTitle: "Ma part",
      revenueShareFull: "60 % si l'admin restreint est assigné · 100 % sur les vôtres",
      revenueShareLimited: "40 % de vos dossiers",
      revenueHypo: "Hypothétique",
      revenueReal: "Réel",
      revenueHypoHint: "{count} formule(s) non payée(s)",
      revenueRealHint: "{count} formule(s) payée(s)",
      assignToMe: "M'attribuer ce dossier",
      ...
      emailThreadEmpty:
        "Aucun email enregistré pour ce contact pour l’instant. Les prochains envois et réponses apparaîtront ici.",
      emailThreadMissingTable:
        "Table contact_emails absente. Exécutez sql/contact-emails.sql dans Supabase, puis actualisez.",
      emailThreadInbound: "Reçu",
      emailThreadOutbound: "Envoyé",
      emailUnreadBadge: "{count} nouveau(x) email(s)",
      colName: "Nom",
      colCountry: "Pays",
      colLevel: "Niveau",
      colDomain: "Domaine",
      ...
      colActions: "Actions",
      lastTouched: "Dernier touché",
      closedBy: "Signé par (prime 40%)",
      ownerNone: "Non attribué",
      view: "Voir",
      editShort: "Modifier",
      deleteShort: "Sup",
      ...
      bulkCollapse: "Réduire",
      bulkExpand: "Ouvrir le panneau",
      bulkCollapsedHint: "Panneau réduit — le tableau reste utilisable. Ouvrez pour rédiger.",
      ...
      contactError: {
        ...
        INVALID_COUNTRY: "Choisissez un pays dans la liste.",
    ...
    statut: {
      ...
      bienvenue_envoyé: "Bienvenue envoyé",
      a_qualifier: "À qualifier",
      appel_réservé: "Appel réservé",
      formules_présentées: "Formules présentées",
      ...
      dossier_préparation: "Dossier en préparation",
      dossier_incomplet: "Dossier incomplet",
      candidature_envoyée: "Candidature envoyée",
      admission_reçue: "Admission reçue",
      visa_préparation: "Visa en préparation",
      arrive_chine: "Arrivé en Chine",
      dossier_terminé: "Dossier terminé",
      prospect_perdu: "Prospect perdu",
      mail_bienvenue_envoyé: "Bienvenue envoyé",
      relance_1_envoyée: "Relance en cours",
      relance_2_envoyée: "Relance en cours",
      choix_des_formules: "Formules présentées",
      prospect_à_qualifier: "À qualifier",
    },
    action: {
      ...
      attribution: "Attribution dossier",
    ...
    formule: {
      "Premier pas en Chine (800€)": "1️⃣ Premier pas en Chine (800€)",
      "Admission universitaire (1700€)": "2️⃣ Admission universitaire (1700€)",
      "Accompagnement complet (2000€)": "3️⃣ Accompagnement complet (2000€)",
      "École de langue (500€)": "1️⃣ Premier pas en Chine (800€)",
      "École de langue (800€)": "1️⃣ Premier pas en Chine (800€)",
      "Admission universitaire (1000€)": "2️⃣ Admission universitaire (1700€)",
      "Bilan personnalisé (100€)": "1️⃣ Premier pas en Chine (800€)",
      "Accompagnement candidature (500€)":
        "2️⃣ Admission universitaire (1700€)",
      "Accompagnement complet (1000€)": "3️⃣ Accompagnement complet (2000€)",
      "Orientation (50€)": "1️⃣ Premier pas en Chine (800€)",
      "Accompagnement candidature (300€)":
        "2️⃣ Admission universitaire (1700€)",
      "Accompagnement complet (500€)": "3️⃣ Accompagnement complet (2000€)",
    },
    step: {
  ...
  en: {
    ...
    calendar: {
      ...
      hint: "Click a cell to add a meeting. Everything is shown in Beijing time.",
      prev: "Prev.",
      next: "Next",
      today: "Today",
      add: "New meeting",
    ...
    dashboard: {
      ...
      paidClients: "Paid",
      filesInPrep: "Application in preparation",
      ...
      filterOwnerMine: "My dossiers",
      filterOwnerLimited: "Limited admin dossiers",
      myTouchesStat: "My dossiers",
      revenueTitle: "My share",
      revenueShareFull: "60% when the limited admin is assigned · 100% on yours",
      revenueShareLimited: "40% of your dossiers",
      revenueHypo: "Projected",
      revenueReal: "Collected",
      revenueHypoHint: "{count} unpaid package(s)",
      revenueRealHint: "{count} paid package(s)",
      assignToMe: "Assign this dossier to me",
      ...
      emailThreadEmpty:
        "No emails stored for this contact yet. Future sends and replies will show up here.",
      emailThreadMissingTable:
        "contact_emails table missing. Run sql/contact-emails.sql in Supabase, then refresh.",
      emailThreadInbound: "Received",
      emailThreadOutbound: "Sent",
      emailUnreadBadge: "{count} new email(s)",
      colName: "Name",
      colCountry: "Country",
      colLevel: "Level",
      colDomain: "Field",
      ...
      closedBy: "Closed by (40% commission)",
      ...
      bulkExpand: "Open panel",
      bulkCollapsedHint: "Panel collapsed — the table stays usable. Open it to write.",
    ...
    statut: {
      ...
      bienvenue_envoyé: "Welcome sent",
      a_qualifier: "To qualify",
      appel_réservé: "Call booked",
      formules_présentées: "Packages presented",
      formule_choisie: "Package chosen",
      offre_envoyée: "Offer sent",
      relance_en_cours: "Follow-up in progress",
      ...
      visa_préparation: "Visa in progress",
      arrive_chine: "Arrived in China",
      dossier_terminé: "File completed",
      prospect_perdu: "Lost prospect",
      mail_bienvenue_envoyé: "Welcome sent",
      relance_1_envoyée: "Follow-up in progress",
      relance_2_envoyée: "Follow-up in progress",
      choix_des_formules: "Packages presented",
      prospect_à_qualifier: "To qualify",
    },
    action: {
      appel: "Call made",
      ...
      attribution: "Dossier assignment",
    ...
    formule: {
      "Premier pas en Chine (800€)": "1️⃣ First steps in China (€800)",
      "Admission universitaire (1700€)": "2️⃣ University admission (€1,700)",
      "Accompagnement complet (2000€)": "3️⃣ Full support (€2,000)",
      "École de langue (500€)": "1️⃣ First steps in China (€800)",
      "École de langue (800€)": "1️⃣ First steps in China (€800)",
      "Admission universitaire (1000€)": "2️⃣ University admission (€1,700)",
      "Bilan personnalisé (100€)": "1️⃣ First steps in China (€800)",
      "Accompagnement candidature (500€)": "2️⃣ University admission (€1,700)",
      "Accompagnement complet (1000€)": "3️⃣ Full support (€2,000)",
      "Orientation (50€)": "1️⃣ First steps in China (€800)",
      "Accompagnement candidature (300€)": "2️⃣ University admission (€1,700)",
      "Accompagnement complet (500€)": "3️⃣ Full support (€2,000)",
    },
    step: {
  ...
  zh: {
    ...
    dashboard: {
      ...
      allBudgets: "全部预算",
      allOwners: "全部负责人",
      filterOwnerMine: "我的客户",
      filterOwnerLimited: "受限管理员的客户",
      myTouchesStat: "我的客户",
      revenueTitle: "我的分成",
      revenueShareFull: "受限管理员负责时 60% · 你自己的客户 100%",
      revenueShareLimited: "你负责的客户的 40%",
      revenueHypo: "预计",
      revenueReal: "已到账",
      revenueHypoHint: "{count} 个未付款套餐",
      revenueRealHint: "{count} 个已付款套餐",
      assignToMe: "将此客户分配给我",
      ...
      emailThreadMissingTable:
        "缺少 contact_emails 表。请在 Supabase 运行 sql/contact-emails.sql 后刷新。",
      emailThreadInbound: "收到",
      emailThreadOutbound: "已发",
      emailUnreadBadge: "{count} 封新邮件",
      colName: "姓名",
      colCountry: "国家",
      colLevel: "学历",
      colDomain: "专业方向",
      ...
      bulkCollapse: "收起",
      bulkExpand: "打开面板",
      bulkCollapsedHint: "面板已收起，可继续操作表格。打开后即可撰写。",
    ...
    statut: {
      nouveau_prospect: "新线索",
      bienvenue_envoyé: "欢迎已发",
      a_qualifier: "待筛选",
      appel_réservé: "已预约通话",
      formules_présentées: "已发送套餐",
      formule_choisie: "已选套餐",
      offre_envoyée: "已发报价",
      relance_en_cours: "跟进中",
      attente_paiement: "待付款",
      client_payé: "客户已付款",
      dossier_préparation: "准备申请材料",
      dossier_incomplet: "材料不全",
      candidature_envoyée: "已提交申请",
      admission_reçue: "已获录取",
      visa_préparation: "签证办理中",
      arrive_chine: "已抵达中国",
      dossier_terminé: "档案已完成",
      prospect_perdu: "已流失",
      mail_bienvenue_envoyé: "欢迎已发",
      relance_1_envoyée: "跟进中",
      relance_2_envoyée: "跟进中",
      choix_des_formules: "已发送套餐",
      prospect_à_qualifier: "待筛选",
    },
    action: {
      appel: "已通话",
      email_envoye: "已发邮件",
    ...
    formule: {
      "Premier pas en Chine (800€)": "1️⃣ 赴华第一步（800€）",
      "Admission universitaire (1700€)": "2️⃣ 大学申请辅导（1700€）",
      "Accompagnement complet (2000€)": "3️⃣ 全程辅导（2000€）",
      "École de langue (500€)": "1️⃣ 赴华第一步（800€）",
      "École de langue (800€)": "1️⃣ 赴华第一步（800€）",
      "Admission universitaire (1000€)": "2️⃣ 大学申请辅导（1700€）",
      "Bilan personnalisé (100€)": "1️⃣ 赴华第一步（800€）",
      "Accompagnement candidature (500€)": "2️⃣ 大学申请辅导（1700€）",
      "Accompagnement complet (1000€)": "3️⃣ 全程辅导（2000€）",
      "Orientation (50€)": "1️⃣ 赴华第一步（800€）",
      "Accompagnement candidature (300€)": "2️⃣ 大学申请辅导（1700€）",
      "Accompagnement complet (500€)": "3️⃣ 全程辅导（2000€）",
    },
    step: {
      inscription: "注册",
      consultation: "初步咨询",
...
export type AdminCopy = (typeof adminTranslations)["fr"];
