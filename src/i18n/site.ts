...
const fr = {
  ...
  blog: {
    crumb: "Blog",
    title: "Blog : étudier en Chine",
    lead: "Guides pratiques sur l’admission, les bourses, la langue, le visa et la vie étudiante en Chine. Un nouvel article publié régulièrement.",
    empty: "Aucun article publié pour le moment.",
    problem: "Problème",
    solution: "Solution",
    promise: "Promesse",
    faqTitle: "Questions fréquentes",
    relatedGuides: "Guides à lire aussi",
    relatedArticles: "Articles liés",
    indexCtaTitle: "Vous préparez un projet d’études en Chine ?",
    indexCtaSubtitle:
      "Décrivez votre profil : nous vous aidons à clarifier le parcours réaliste (langue, admission, bourse, visa).",
  },
  hero: {
  ...
  contact: {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "Vous pouvez nous écrire par e-mail ou WeChat pendant les heures de bureau (heure de Pékin).",
      },
      {
...
const en = {
  ...
  blog: {
    crumb: "Blog",
    title: "Blog: studying in China",
    lead: "Practical guides on admission, scholarships, language programs, student visas, and campus life in China. New articles published regularly.",
    ...
    indexCtaTitle: "Planning to study in China?",
    indexCtaSubtitle:
      "Tell us about your profile: we help clarify a realistic path (language, admission, scholarship, visa).",
  },
  hero: {
  ...
  contact: {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "You can write to us by email or WeChat during office hours (Beijing time).",
      },
      {
...
export type SiteLang = keyof typeof siteTranslations;
