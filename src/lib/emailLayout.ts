...
export function sanitizeEmailSubject(value: unknown, maxLen = 180) {
  return String(value ?? "")
    .replace(/[\r\n\u0000-\u001f\u007f\u2028\u2029]/g, " ")
    .replace(/\s+/g, " ")
    .trim()
...
function stripEtudeChineMarker(value: unknown) {
  return String(value || "")
...
export function withEtudeChineSubject(value: unknown, maxLen = 180) {
