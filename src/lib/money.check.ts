...
assert(
  withCfaInText("800 €") === "800 € (524 766 F CFA)",
  "suffix 800",
);
assert(
  withCfaInText("La formule 1 (800 €) et la 2 (1 700 €).") ===
    "La formule 1 (800 € (524 766 F CFA)) et la 2 (1 700 € (1 115 127 F CFA)).",
...
assert(
  withCfaInText("€1,700") === "€1,700 (1 115 127 F CFA)",
  "english thousands",
);
assert(
  withCfaInText("250 à 500 euros") ===
    "250 à 500 euros (163 989 à 327 979 F CFA)",
  "range à",
);
assert(
  withCfaInText("50-100 euros") === "50-100 euros (32 798-65 596 F CFA)",
  "range hyphen",
);
assert(
  withCfaInText("1 à 2,50 €") === "1 à 2,50 € (656 à 1 640 F CFA)",
  "decimal range",
);
